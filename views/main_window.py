...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.encrypt_btn.setMinimumHeight(32)
        self.encrypt_btn.setObjectName("config_btn")
        self.encrypt_btn.setCursor(Qt.CursorShape.PointingHandCursor)

        self.decrypt_btn = QPushButton("Decrypt")
        self.decrypt_btn.setMinimumHeight(32)
        self.decrypt_btn.setObjectName("config_btn")

        self.gen_key_and_iv = QPushButton("Generate Key and IV")
        self.gen_key_and_iv.setMinimumHeight(32)
        self.gen_key_and_iv.setObjectName("config_btn")

        self.info_label = QLabel("Operacja zakończona sukcesem!")
        ...
        file_layout.setContentsMargins(0, 0, 0, 40)
